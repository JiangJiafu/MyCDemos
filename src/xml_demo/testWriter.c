...
testXmlwriterTree(const char *file)
{
     ...
     * in iso-8859-1 */
    tmp = ConvertInput("This is a comment with special chars: <....ahha>",
                       MY_ENCODING);
    ...
    tmp = ConvertInput("<no good>", MY_ENCODING);
    ...
    tmp = ConvertInput("xxeller", MY_ENCODING);
    ...
    tmp = ConvertInput("Jdfg", MY_ENCODING);
    ...
    xmlSaveFormatFileEnc(file, doc, MY_ENCODING, 4);
